...
public class Rahenanidwwanaysye extends AppCompatActivity {
    Button next;
    int scoreRahenanidw;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rahinanidw_wanay_sye);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fourthRadioButton.isChecked()){
                    Toast.makeText( Rahenanidwwanaysye.this, "پەنجەرە د ی تیا نیە هەولدەوە", Toast.LENGTH_SHORT).show();
                ...
                {
                    intent = new Intent( Rahenanidwwanaysye.this, Rahenanidwwanaysye.class);
                startActivity(intent);
                }
                else if(scoreRahenanidw<3 && !(fourthRadioButton.isChecked()))
                  Toast.makeText( Rahenanidwwanaysye.this, "هەموو وەڵامە راستەکانت نەدۆزیەوە، دوبارە هەولدەوە", Toast.LENGTH_SHORT).show();
                else if(scoreRahenanidw<3 && (fourthRadioButton.isChecked())) {
                    Toast.makeText( Rahenanidwwanaysye.this, "هەموو وەڵامە راستەکانت دۆزیەوە،بەلام پەنجەرە د ی تیا نیە", Toast.LENGTH_SHORT).show();
                }
            }
        });
