...
public class Rahenanidwwanaydw extends AppCompatActivity {
    Button next;
    int scoreRahenanidw;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rahinanidw_wanay_dw);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fourthRadioButton.isChecked()){
                    Toast.makeText(Rahenanidwwanaydw.this, "پەنجەرە د ی تیا نیە هەولدەوە", Toast.LENGTH_SHORT).show();
                ...
                {
                    intent = new Intent(Rahenanidwwanaydw.this,SplitL2Activity.class);
                startActivity(intent);
                }
                else if(scoreRahenanidw<3 && !(fourthRadioButton.isChecked()))
                  Toast.makeText(Rahenanidwwanaydw.this, "هەموو وەڵامە راستەکانت نەدۆزیەوە، دوبارە هەولدەوە", Toast.LENGTH_SHORT).show();
                else if(scoreRahenanidw<3 && (fourthRadioButton.isChecked())) {
                    Toast.makeText(Rahenanidwwanaydw.this, "هەموو وەڵامە راستەکانت دۆزیەوە،بەلام پەنجەرە د ی تیا نیە", Toast.LENGTH_SHORT).show();
                }
            }
        });
