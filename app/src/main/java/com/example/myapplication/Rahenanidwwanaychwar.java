...
public class Rahenanidwwanaychwar extends AppCompatActivity {
    Button next;
    int scoreRahenanidw;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rahinanidw_wanay_chwar);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fourthRadioButton.isChecked()){
                    Toast.makeText( Rahenanidwwanaychwar.this, "پەنجەرە د ی تیا نیە هەولدەوە", Toast.LENGTH_SHORT).show();
                ...
                {
                    intent = new Intent( Rahenanidwwanaychwar.this, Rahenanidwwanaychwar.class);
                startActivity(intent);
                }
                else if(scoreRahenanidw<3 && !(fourthRadioButton.isChecked()))
                  Toast.makeText( Rahenanidwwanaychwar.this, "هەموو وەڵامە راستەکانت نەدۆزیەوە، دوبارە هەولدەوە", Toast.LENGTH_SHORT).show();
                else if(scoreRahenanidw<3 && (fourthRadioButton.isChecked())) {
                    Toast.makeText( Rahenanidwwanaychwar.this, "هەموو وەڵامە راستەکانت دۆزیەوە،بەلام پەنجەرە د ی تیا نیە", Toast.LENGTH_SHORT).show();
                }
            }
        });
